...
- **[Output Structure](output.md)**: what gets written where, and what every tag means, including Picard-standard multi-artist tags (`ARTISTS`, aligned `MUSICBRAINZ_ARTISTID`) that let Lyrion and Jellyfin link every collaborator and remixer.
